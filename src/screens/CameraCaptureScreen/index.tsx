...
const CameraCaptureScreen = () => {
  const navigation =
    useNavigation<NativeStackNavigationProp<RootStackParamList, 'CameraCapture'>>();
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Icon xml={flashSvg} size={24} color={flashEnabled ? colors.yellow : colors.white} />
      </TouchableOpacity>
      ...
      <View style={styles.previewFrame}>
        {hasPermission && device ? (
          ...
          <View style={styles.previewFallback}>
            {!hasPermission ? (
              <Text style={styles.previewMessage}>카메라 권한을 허용해주세요</Text>
            ) : (
      ...
      <Text style={styles.helperText}>{params.memberName}님에게 보여줄 인증사진이에요</Text>
